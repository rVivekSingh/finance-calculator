...
<nav className="bg-white border-gray-200 dark:bg-gray-900 w-full">
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <img src="https://img.icons8.com/color/96/null/apple-calculator.png" className="h-8 mr-3"  alt="Emi Ninja"/>
        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">EmiNinja</span>
    </a>
