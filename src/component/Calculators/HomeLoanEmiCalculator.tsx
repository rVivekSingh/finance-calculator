...
const HomeLoanEmiCalculator = () => {
  const [loanAmount, setLoanAmount] = useState<number | undefined>(2000000);
  const [interestRate, setInterestRate] = useState<number | undefined>(9);
  const [tenure, setTenure] = useState<number | undefined>(20);
  ...
  return (
    <Section title="Home Loan EMI Calculator">
      <Card>
        <CardBody>
          <CardForm>
